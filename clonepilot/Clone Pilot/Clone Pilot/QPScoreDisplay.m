...
- (void)generateLabels {
    ...
    self.timeScoreLabel.position = ccp(384,300);
    ...
    NSString *accuracyScoreString = [NSString stringWithFormat:@"%f x %d", self.accuracy, [self accuracyScoreModifier]];
    self.accuracyScoreLabel = [CCLabelTTF labelWithString:accuracyScoreString fontName:@"Courier New" fontSize:23];
    self.accuracyScoreLabel.position = ccp(384,450);
    ...
    self.modifierScoreLabel.position = ccp(384,600);
