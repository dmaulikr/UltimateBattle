#import "SplitLaser.h"
#import "SplitLaserBullet.h"
#import "VRGeometry.h"

@implementation SplitLaser

- (NSArray *)newBulletsForLocation:(CGPoint)location direction:(NSInteger)direction {
    SplitLaserBullet *b   = [[[SplitLaserBullet alloc] initWithLocation:location velocity:CGPointMake(0, direction)] autorelease];
    SplitLaserBullet *b2  = [[[SplitLaserBullet alloc] initWithLocation:location velocity:CGPointMake(0, direction)] autorelease];
